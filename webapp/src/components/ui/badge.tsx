...
const Badge = React.forwardRef<HTMLDivElement, BadgeProps>(
  ({ className, variant = "default", ...props }, ref) => {
    const variants = {
      ...
      success:
        "border-transparent bg-green-500 text-white shadow hover:bg-green-500/80 dark:bg-green-600",
      warning:
        "border-transparent bg-yellow-500 text-gray-900 shadow hover:bg-yellow-500/80 dark:bg-yellow-600",
    };
